...
Published: 2017-06-16 18:02:48 +0000
...
var form_selector = '#page4-ydfl-form';
var submitBtnText = $('#page4-ydfl-form button.ydfl-submit').html();
var loginBtnText = 'Login';
    
/* Validate and Submit
========================================================*/

$('#page4-ydfl-form').validate({
        ...
        success:function(data){
				...
				}else if(rs.result == 'loginsuccess')
				{
					...
					if(rs.redirect)
					{
						...
						var msg = '<div class="notification alert-success spacer-t10"><p><i class="fa fa-check"></i> <b>Your form was sent successfully. Thank you!</b></p><a href="#" class="close-btn">&times;</a></div>';
